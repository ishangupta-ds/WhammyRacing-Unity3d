...
{
	public GameObject PlayerObject, PlayerObject2;
	...
	void Update ()
	{
        ...
        Vector3 playerPosition2 = new Vector3(PlayerObject2.transform.position.x, PlayerObject2.transform.position.y, PlayerObject2.transform.position.z);
		...
		for (int x = 0; x < 3; x++)
		{
			for (int y = 0; y < 3; y++)
			{
				if ((playerPosition.x >= _terrainGrid[x,y].transform.position.x) &&
					...
					(playerPosition.z <= (_terrainGrid[x,y].transform.position.z + _terrainGrid[x,y].terrainData.size.z)) || (playerPosition2.x >= _terrainGrid[x, y].transform.position.x) &&
                    (playerPosition2.x <= (_terrainGrid[x, y].transform.position.x + _terrainGrid[x, y].terrainData.size.x)) &&
                    (playerPosition2.z >= _terrainGrid[x, y].transform.position.z) &&
                    (playerPosition2.z <= (_terrainGrid[x, y].transform.position.z + _terrainGrid[x, y].terrainData.size.z)))
				{
